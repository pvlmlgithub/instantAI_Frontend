...
import { Trash2, AlertCircle, CheckCircle, ArrowRight } from "lucide-react"
...
const SelectColumns = () => {
  ...
  const handleDrop = async () => {
    if (droppedColumns.length > 0) {
      try {
        ...
        sessionStorage.setItem("droppedColumns", JSON.stringify(droppedColumnNames))
      } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    sessionStorage.setItem("importantColumnNames", JSON.stringify(importantColumnNames))
