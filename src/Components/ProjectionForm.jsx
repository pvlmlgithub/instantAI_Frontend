...
const ProjectionForm = () => {
  ...
  const importantColumnNames = sessionStorage.getItem("importantColumnNames");
    ...
    <div className="max-w-2xl mx-auto mt-8 bg-white rounded-lg shadow-lg p-6">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-800">
          Time Series Projection Configuration
        </h2>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-2">
          <label 
            htmlFor="zero_value_replacement" 
            className="block text-sm font-medium text-gray-700"
          >
